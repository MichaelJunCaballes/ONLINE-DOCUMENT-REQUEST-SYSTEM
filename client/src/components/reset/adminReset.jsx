...
import { resetPasswordValidation } from '../../helper/validate3';
import { resetPassword } from '../../helper/adminhelper';
...
function StudentReset() {
  ...
  const formik = useFormik({
    ...
    onSubmit : async values => {
      ...
      resetPromise.then(function(){ navigate('/admin/password') })
  ...
  if(status && status !== 201) return <Navigate to={'/admin/password'} replace={true}></Navigate>
