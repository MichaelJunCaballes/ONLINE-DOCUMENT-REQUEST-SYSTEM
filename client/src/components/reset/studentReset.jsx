...
import { resetPassword } from '../../helper/studenthelper';
...
function StudentReset() {
  ...
  const formik = useFormik({
    ...
    onSubmit : async values => {
      ...
      resetPromise.then(function(){ navigate('/student/password') })
  ...
  if(status && status !== 201) return <Navigate to={'/student/password'} replace={true}></Navigate>
