...
import { updateUser } from '../../helper/studenthelper';
  ...
  <div id="page-content-wrapper">
    <nav className="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
      <div className="d-flex align-items-center">
        ...
        <h2 className="fs-2 m-0">Student Profile</h2>
      </div>
    ...
    {/* Profile Content */}
    <div style={{ marginLeft: '30px', backgroundColor: 'white', marginRight: "10px", borderRadius: "25px" , width: "70%", height: "83%"}}>
      ...
      <form className="col-lg-8">
        <div className="card mb-4">
          <div className="card-body">
            ...
            <div className="row">
              <div className="col-sm-3">
                <p className="mb-0">Grade Level</p>
              </div>
              <div className="col-sm-9">
                <input {...formik.getFieldProps('gradeLevel')} className="form-control form-control-lg bg-light fs-6" type="text" placeholder='ex. Grade 10' />
              </div>
            </div>
            <hr />
            <div className="row">
              ...
              <div className="col-sm-9">
                <input {...formik.getFieldProps('lrnNo')} className="form-control form-control-lg bg-light fs-6" type="text" placeholder='ex. 126496080080' />
              </div>
            </div>
          </div>
        </div></form>
