  ...
  return (
    <div className="d-flex" id="wrapper">
        ...
        <div className="bg-white" id="sidebar-wrapper">
            ...
            <Link to="/registrar/list" style={linkStyle} className="list-group-item list-group-item-action bg-transparent second-text active">
                <i className="fas fa-tachometer-alt me-2" />Requests
            </Link>
            <Link to="/registrar/update" style={linkStyle} className="list-group-item list-group-item-action bg-transparent second-text active">
                <i className="fas fa-tachometer-alt me-2" />Update Request
            </Link>
            ...
            <Link to="/registrar/accounts" style={linkStyle} className="list-group-item list-group-item-action bg-transparent second-text active">
            ...
            <div className="container-fluid px-4">
                <div className="row g-3 my-2">
                    ...
                    <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        ...
                        <p className="fs-5">Accepted Requests</p>
                        </div>
                    ...
                    <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        <div>
                        <h3 className="fs-2">0</h3>
                        <p className="fs-5">Declined Requests</p>
                        </div>
                    ...
                    <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        <div>
                        <h3 className="fs-2">0</h3>
                        <p className="fs-5">Finished Requests</p>
                        </div>
                    ...
                    <div className="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                        <div>
                        <h3 className="fs-2">0</h3>
                        <p className="fs-5">Student Accounts</p>
                        </div>
                        <i className="fas fa-truck fs-1 primary-text border rounded-full secondary-bg p-3" />
                    </div>
                    </div>
